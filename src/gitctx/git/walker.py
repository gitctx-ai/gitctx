...
class CommitWalker:
    ...
    def _collect_tree_blobs(
        ...
        for entry in tree:
            if entry.type_str == "blob":
                ...
                if subtree:
                    self._collect_tree_blobs(subtree, blob_set)  # type: ignore[arg-type]
    ...
    def _read_gitignore_from_head(self) -> str:
        ...
        try:
            ...
            if not gitignore_blob:
                return ""
            return gitignore_blob.data.decode("utf-8", errors="ignore")  # type: ignore[attr-defined,no-any-return]
    ...
    def _build_head_tree(self) -> set[str]:
        ...
        self._collect_tree_blobs(head_commit.tree, head_blobs)
        return head_blobs
    ...
    def _accumulate_blob_locations(
        self,
        tree: pygit2.Tree,
        ...
        """
        from .types import BlobLocation
