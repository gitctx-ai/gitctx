...
- [ ] Create test directory structure (unit/ and e2e/)
- [ ] Set up conftest.py with shared fixtures
- [ ] Configure pytest-bdd for Gherkin scenarios
- [ ] Write first BDD feature file (cli.feature)
- [ ] Implement step definitions for basic scenario
- [ ] Set up coverage reporting
- [ ] Create test runner script
- [ ] Verify all tests pass with coverage >90%
...
- [ ] pytest-bdd is configured and working
- [ ] First BDD scenario passes (version display)
- [ ] Coverage reporting is configured
- [ ] Tests can be run with `uv run pytest`
- [ ] Coverage is reported with tests
