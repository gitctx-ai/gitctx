...
- [ ] Add `invoke_without_command=True` to show quick start guide
- [ ] Customize Typer error formatting (remove panels, use terse format)
- [ ] Add "did you mean?" suggestions for command typos
- [ ] Verify exit codes match TUI_GUIDE.md specification
- [ ] Enable existing BDD test: "Missing required arguments"
- [ ] Add new BDD test: "Empty command shows quick start"
- [ ] Add unit tests for command suggestions
- [ ] Test terse error format matches TUI_GUIDE.md
...
- [ ] Empty command shows quick start guide (not error)
- [ ] Exit codes match TUI_GUIDE.md (0=success, 2=usage)
- [ ] Error messages are terse (no elaborate Rich panels if possible)
- [ ] Command suggestions for typos (nice to have)
...
- **Main additions needed**: Quick start guide, command suggestions
