...
- [ ] Implement `register()` function for command group
- [ ] Add `config set <key> <value>` subcommand with terse output (TUI_GUIDE.md line 776)
- [ ] Add `config get <key>` subcommand with masked output (TUI_GUIDE.md line 781)
- [ ] Add `config list` subcommand showing all settings (TUI_GUIDE.md lines 787-793)
- [ ] Use in-memory dict for mock storage (NO file I/O)
- [ ] Mask sensitive values in output (API keys: `sk-...abc` format)
- [ ] Implement environment variable precedence (env > config file)
- [ ] NO Rich panels, tables, or Tree - use simple console.print()
...
- [ ] `gitctx config` command group exists
- [ ] `config set <key> <value>` shows terse confirmation (TUI_GUIDE.md line 776)
- [ ] `config get <key>` retrieves and masks values (TUI_GUIDE.md line 781)
- [ ] `config list` shows all settings in `key=value` format (TUI_GUIDE.md lines 787-793)
- [ ] Dot notation works for nested keys
- [ ] Sensitive values are masked: `sk-...abc` format
- [ ] Environment variables override config values
- [ ] In-memory storage (NO file I/O, no .gitctx directory creation)
- [ ] NO Rich panels, tables, or Tree views - simple console.print()
- [ ] Help text includes examples
- [ ] Unit tests pass for all subcommands
- [ ] BDD scenarios for config pass
