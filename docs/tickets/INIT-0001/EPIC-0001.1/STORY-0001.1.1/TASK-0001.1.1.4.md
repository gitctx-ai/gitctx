...
- [ ] Create `src/gitctx/cli/clear.py` module
- [ ] Implement `register()` function to add command to app
- [ ] Add `--force/-f` flag to skip confirmation
- [ ] Add `--database/-d` flag to clear database
- [ ] Add `--embeddings/-e` flag to clear embeddings
- [ ] Add `--all/-a` flag to clear everything
- [ ] Implement confirmation prompts using Typer
- [ ] Show what will be deleted before confirmation
- [ ] Enable BDD test: "Clear command help"
- [ ] Add unit tests for flag combinations
